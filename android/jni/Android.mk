...
ifeq ($(TARGET_ARCH_ABI), armeabi-v7a)
    ...
    # NDK r24+ ndk-build errors if LOCAL_ARM_NEON is false ("non-Neon code is no longer supported").
    # Prebuilt FFmpeg may still target v7a with or without Neon; the JNI wrapper must compile with Neon.
    MY_ARM_NEON := true
endif
